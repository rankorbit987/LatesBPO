...
const Testimonials = () => {
  ...
  return (
    <div className="py-16 px-4 sm:px-6 lg:px-8 relative bg-gradient-to-r from-[#0F172A] via-[#1E293B] to-[#0F172A]">
      <style jsx global>{`
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-[#C93C3C] mb-3">
            Client Testimonials
          </h2>
